...
Original file is located at
    https://colab.research.google.com/drive/10iOnMZPIgIhZcgVCfQ5WTq06U7rLHj5d
...
size_of_arr=array.size
mem_of_ele=array.itemsize
memory_of_array=(size_of_arr*mem_of_ele)
print(memory_of_array)
...
check1=np.allclose(x,y)
check2=np.array_equal(x,y)
print(check1)
print(check2)
...
i=1+(a.shape[0]-3)
j=1+(a.shape[1]-3)
x=stride_tricks.as_strided(a,shape=(i,j,n,n),strides=a.strides+a.strides)
print(x)
...
a=np.ones((p,n,n))
b=np.ones((p,n,1))
a=np.tensordot(a,b,axes=[[0, 2],[0, 1]])
print(a)
...
x=np.ones((16,16))
n=4
a=np.add.reduceat(np.add.reduceat(x,np.arange(0,x.shape[0],n),axis=0),
